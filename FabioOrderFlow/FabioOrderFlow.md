...
Non esistono modelli direzionali, tool strategici o automazione. I contratti attivi sono `../docs/research/participation-effort-result-observation-contract.md`, `../docs/research/session-location-and-price-response-collection-contract.md`, `../docs/research/historical-cumulative-context-collection-contract.md` e `../docs/research/historical-cumulative-cash-session-description-contract.md`.
