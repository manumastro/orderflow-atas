...
- `[MR_PROFILE_CONTEXT]` e' solo diagnostica ENTRY_ONLY sui profili intraday (`ProfileSource=CurrentLondonSessionProfile|LocalRotationProfile`), non modifica entry/exit/PnL;
