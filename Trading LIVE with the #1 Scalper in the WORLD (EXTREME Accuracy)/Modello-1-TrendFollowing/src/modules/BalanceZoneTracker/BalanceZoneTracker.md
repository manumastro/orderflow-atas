...
Per i long cerca prima il momento dello sweep del low della candidate e poi solo buy aggression successive; per gli short fa l'equivalente sullo sweep high. La soglia minima segue l'appunto operativo Fabio: `London20`, `NewYork30` con precedenza a New York in sovrapposizione. Questo è il log più vicino all'idea Fabio di ingresso sui big trades.
