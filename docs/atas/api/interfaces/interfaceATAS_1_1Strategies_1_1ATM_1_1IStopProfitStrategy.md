# ATAS.Strategies.ATM.IStopProfitStrategy< TSettings > Interface Template Reference

Source: https://docs.atas.net/en/interfaceATAS_1_1Strategies_1_1ATM_1_1IStopProfitStrategy.html

Inheritance diagram for ATAS.Strategies.ATM.IStopProfitStrategy< TSettings >:

This browser is not able to show SVG: try Firefox, Chrome, Safari, or Opera instead.

[[legend](../overviews/graph_legend.md)]

Collaboration diagram for ATAS.Strategies.ATM.IStopProfitStrategy< TSettings >:
...
| new TSettings [ATAS.Strategies.ATM.IStopProfitStrategy](./interfaceATAS_1_1Strategies_1_1ATM_1_1IStopProfitStrategy.md).GetSettings | ( | | ) | |
| --- | --- | --- | --- | --- |

Implements [ATAS.Strategies.ATM.IATMStrategy](./interfaceATAS_1_1Strategies_1_1ATM_1_1IATMStrategy.md#aaad791303b09343ea759213efbd8fabe).

Implemented in [ATAS.Strategies.ATM.BaseStopProfitStrategy](../classes/classATAS_1_1Strategies_1_1ATM_1_1BaseStopProfitStrategy.md#adac77a8844a40163402068af1f951bc3).

## [◆](https://docs.atas.net/en/)IsValidSettings()

| bool IEnumerable Errors [ATAS.Strategies.ATM.IStopProfitStrategy](./interfaceATAS_1_1Strategies_1_1ATM_1_1IStopProfitStrategy.md).IsValidSettings | ( | TSettings | settings, |
| --- | --- | --- | --- |
| | | decimal? | expectedPositionVolume = `null`, |
| | | decimal? | expectedPositionPrice = `null` |
| | ) | | |

Implemented in [ATAS.Strategies.ATM.BaseStopProfitStrategy](../classes/classATAS_1_1Strategies_1_1ATM_1_1BaseStopProfitStrategy.md#aa87824f6745908767e037c80afee3c0d).

## [◆](https://docs.atas.net/en/)SetSettings()

| void [ATAS.Strategies.ATM.IStopProfitStrategy](./interfaceATAS_1_1Strategies_1_1ATM_1_1IStopProfitStrategy.md).SetSettings | ( | TSettings | settings | ) | |
| --- | --- | --- | --- | --- | --- |

Implemented in [ATAS.Strategies.ATM.BaseStopProfitStrategy](../classes/classATAS_1_1Strategies_1_1ATM_1_1BaseStopProfitStrategy.md#af7d303bfb2a7d3d2f1e0fb06df781280).

## Member Data Documentation

## [◆](https://docs.atas.net/en/)IsValid

| bool [ATAS.Strategies.ATM.IStopProfitStrategy](./interfaceATAS_1_1Strategies_1_1ATM_1_1IStopProfitStrategy.md).IsValid |
| --- |
