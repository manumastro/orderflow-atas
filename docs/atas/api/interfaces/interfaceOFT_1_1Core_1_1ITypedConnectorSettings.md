# OFT.Core.ITypedConnectorSettings Interface Reference

Source: https://docs.atas.net/en/interfaceOFT_1_1Core_1_1ITypedConnectorSettings.html

Inheritance diagram for OFT.Core.ITypedConnectorSettings:

This browser is not able to show SVG: try Firefox, Chrome, Safari, or Opera instead.

[[legend](../overviews/graph_legend.md)]

Collaboration diagram for OFT.Core.ITypedConnectorSettings:
...
| Properties | |
| --- | --- |
| string | [ConnectionType](./interfaceOFT_1_1Core_1_1ITypedConnectorSettings.md#ab891ac1c8430a06bfb88b4dec7cb8771)`[get, set]` |
| | |
...
## [◆](https://docs.atas.net/en/)ConnectionType
