# ATAS.DataFeedsCore.ICryptoKeySecretConnector Interface Reference

Source: https://docs.atas.net/en/interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.html

Inheritance diagram for ATAS.DataFeedsCore.ICryptoKeySecretConnector:

This browser is not able to show SVG: try Firefox, Chrome, Safari, or Opera instead.

[[legend](../overviews/graph_legend.md)]

Collaboration diagram for ATAS.DataFeedsCore.ICryptoKeySecretConnector:
...
| --- | --- |
| void | [DropMarketDataConnection](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#ad1bad363fc5eae529036619dc44319d7) () |
| | |
| void | [DropTradingConnection](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#ae0962cbf93c7300293a6eee640a5e8b0) () |
| | |
| void | [DropMarketDataConnectionDuringConnecting](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#a1109b08fb603f18701c76d92a385940f) () |
| | |
| void | [DropTradingConnectionDuringConnecting](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#a70900272b4f5ec37dd9b23eacae5c272) () |
| | |
| Task | [DropMarketDataConnectionCoupleTimes](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#ab1f1b75f681906516a572b0c1109b600) (int reboots=5) |
| | |
...
| Properties | |
| --- | --- |
| SecureString? | [ApiKey](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#a444bda81564fc32836bce09c65107a05)`[get, set]` |
| | |
| SecureString? | [Secret](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#a571fd98d7a860462494f65cd384e989b)`[get, set]` |
| | |
| bool | [MarketDataOnly](./interfaceATAS_1_1DataFeedsCore_1_1ICryptoKeySecretConnector.md#aca16ece73eefb29c86167653792304ec)`[get, set]` |
| | |
...
| void ATAS.DataFeedsCore.ICryptoKeySecretConnector.DropMarketDataConnection | ( | | ) | |
| --- | --- | --- | --- | --- |

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#a137aa029f55e8ef2405d0283c504b1d7), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#aa92455c9e2683465342cef9175ff0f36).

## [◆](https://docs.atas.net/en/)DropMarketDataConnectionCoupleTimes()

| Task ATAS.DataFeedsCore.ICryptoKeySecretConnector.DropMarketDataConnectionCoupleTimes | ( | int | reboots = `5` | ) | |
| --- | --- | --- | --- | --- | --- |

Implemented in [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#a8657993c9b9cedf3996439d868bfee6b), and [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#afafabc702b255e3405d98f89141e880f).

## [◆](https://docs.atas.net/en/)DropMarketDataConnectionDuringConnecting()

| void ATAS.DataFeedsCore.ICryptoKeySecretConnector.DropMarketDataConnectionDuringConnecting | ( | | ) | |
| --- | --- | --- | --- | --- |

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#a247488c34311828f242acddab2a9ecde), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#a14c180f20980c3762c511c989063c8b1).

## [◆](https://docs.atas.net/en/)DropTradingConnection()

| void ATAS.DataFeedsCore.ICryptoKeySecretConnector.DropTradingConnection | ( | | ) | |
| --- | --- | --- | --- | --- |

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#a8e0ecc80cfea7983c7d93ada1102a1d0), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#a6d5c7011618213da1d5d720ae2f08033).

## [◆](https://docs.atas.net/en/)DropTradingConnectionDuringConnecting()

| void ATAS.DataFeedsCore.ICryptoKeySecretConnector.DropTradingConnectionDuringConnecting | ( | | ) | |
| --- | --- | --- | --- | --- |

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#a64037950181dfbfeaeb33fb00810ef00), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#aec52568d9f50d9af765ebab32ca64694).

## Property Documentation

## [◆](https://docs.atas.net/en/)ApiKey

| SecureString? ATAS.DataFeedsCore.ICryptoKeySecretConnector.ApiKey |
| --- |

getset

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#a627a573de7b720827ab46a6dbf98f5b0), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#a109dd257ab1ad9dc7394e4473a50ae91).

## [◆](https://docs.atas.net/en/)MarketDataOnly

| bool ATAS.DataFeedsCore.ICryptoKeySecretConnector.MarketDataOnly |
| --- |

getset

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#a9c29cc5c7e1da2767aa51aa49004cbca), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#a73ee5d80c83afd3fd1ca5a7a6c9e4963).

## [◆](https://docs.atas.net/en/)Secret

| SecureString? ATAS.DataFeedsCore.ICryptoKeySecretConnector.Secret |
| --- |

getset

Implemented in [ATAS.DataFeedsCore.CryptoAsyncConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoAsyncConnector.md#ad9df166303b1ba0fd52efb18114b0b8c), and [ATAS.DataFeedsCore.CryptoBaseConnector](../classes/classATAS_1_1DataFeedsCore_1_1CryptoBaseConnector.md#a77bf799eb490cba7d54fcff6323da90e).
