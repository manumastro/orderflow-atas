# ATAS.Indicators.FilterString Class Reference

Source: https://docs.atas.net/en/classATAS_1_1Indicators_1_1FilterString.html

Represents a filter for string values with support for property change notifications.
 [More...](./classATAS_1_1Indicators_1_1FilterString.md#details)

Inheritance diagram for ATAS.Indicators.FilterString:

This browser is not able to show SVG: try Firefox, Chrome, Safari, or Opera instead.

[[legend](../overviews/graph_legend.md)]

Collaboration diagram for ATAS.Indicators.FilterString:
...
| --- | --- |
| | [FilterString](./classATAS_1_1Indicators_1_1FilterString.md#a6c064be81e73503657371cbca404f531) (bool enableVisible, bool asScalar=false) |
| | Initializes a new instance of the FilterString class with the specified visibility settings. |
| | |
| | [FilterString](./classATAS_1_1Indicators_1_1FilterString.md#a3e211591d2366ace798b8fdde723858a) () |
| | Initializes a new instance of the FilterString class with default visibility settings. |
| | |
...
| --- | --- |
| override string | [GetRealValue](./classATAS_1_1Indicators_1_1FilterString.md#ab301cb28c0dffd1b21777200a1d87935) (string? value) |
| | |
...
## [◆](https://docs.atas.net/en/)FilterString() [1/2]

| ATAS.Indicators.FilterString.FilterString | ( | bool | enableVisible, |
| --- | --- | --- | --- |
| | | bool | asScalar = `false` |
| | ) | | |
...
| enableVisible | A value indicating whether the filter is visible. |
| --- | --- |
| asScalar | A value indicating whether the filter represents a scalar value. |

## [◆](https://docs.atas.net/en/)FilterString() [2/2]
...
| override string ATAS.Indicators.FilterString.GetRealValue | ( | string? | value | ) | |
| --- | --- | --- | --- | --- | --- |
