...
Source: https://docs.atas.net/en/classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.html
...
| --- | --- |
| | [BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md#ae7b635b9784a7b9c72a53df8a2979765) () |
| | |
| sealed override bool | [CompareCredentials](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md#adda75885baa232ab0af4c0eba19f751f) ([IConnectorSettings](../interfaces/interfaceOFT_1_1Core_1_1IConnectorSettings.md) other) |
...
| | |
| abstract bool | [CompareCredentials](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md#a365aeb5e209306595a2e5376eaa41871) (TSelf other) |
| | |
| override void | [OnApplySettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md#a838dce3f9bb93ad539365cdce841a698) ([IDataFeedConnector](../interfaces/interfaceATAS_1_1DataFeedsCore_1_1IDataFeedConnector.md) connector) |
| | |
...
| Properties | |
| --- | --- |
| TDataFeedSettings | [DataFeedSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md#ac1056d2b362b3b3d206371b19e402b8d)`[get]` |
| | |
| TTradingSettings | [TradingSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md#a2343cbfb08b7b724700f8ab71a9abf95)`[get]` |
| | |
...
## [◆](https://docs.atas.net/en/)BasketConnectorSettings()

| [ATAS.DataFeedsCore.BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md).[BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md) | ( | | ) | |
| --- | --- | --- | --- | --- |
...
## [◆](https://docs.atas.net/en/)CompareCredentials() [1/2]

| sealed override bool [ATAS.DataFeedsCore.BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md).CompareCredentials | ( | [IConnectorSettings](../interfaces/interfaceOFT_1_1Core_1_1IConnectorSettings.md) | other | ) | |
| --- | --- | --- | --- | --- | --- |
...
Implements [OFT.Core.BaseConnectorSettings](./classOFT_1_1Core_1_1BaseConnectorSettings.md#a1c112130945ecba9a1b2f15a5c173f5f).

## [◆](https://docs.atas.net/en/)CompareCredentials() [2/2]

| abstract bool [ATAS.DataFeedsCore.BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md).CompareCredentials | ( | TSelf | other | ) | |
| --- | --- | --- | --- | --- | --- |

protectedpure virtual

Implements [OFT.Core.BaseConnectorSettings](./classOFT_1_1Core_1_1BaseConnectorSettings.md#a980e150622049ebafd642e501fd2bf47).

## [◆](https://docs.atas.net/en/)OnApplySettings()

| override void [ATAS.DataFeedsCore.BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md).OnApplySettings | ( | [IDataFeedConnector](../interfaces/interfaceATAS_1_1DataFeedsCore_1_1IDataFeedConnector.md) | connector | ) | |
| --- | --- | --- | --- | --- | --- |

protectedvirtual

Implements [OFT.Core.BaseConnectorSettings](./classOFT_1_1Core_1_1BaseConnectorSettings.md#af6e636a0381112b81493c5b7815f80fc).

## Property Documentation

## [◆](https://docs.atas.net/en/)DataFeedSettings

| TDataFeedSettings [ATAS.DataFeedsCore.BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md).DataFeedSettings |
| --- |

get

## [◆](https://docs.atas.net/en/)TradingSettings

| TTradingSettings [ATAS.DataFeedsCore.BasketConnectorSettings](./classATAS_1_1DataFeedsCore_1_1BasketConnectorSettings.md).TradingSettings |
| --- |
